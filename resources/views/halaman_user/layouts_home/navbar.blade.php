        ...
        @if (Auth::user())
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-4 text-right hidden-xs menu-2">
                    <ul>
                        <li> <a href="https://web.whatsapp.com/send?phone=.+6282286486113.&text=hello buk, saya mau konsultasi, apakah ibuk sibuk hari ini?"
                                target="blank" style="color:green; font-weight:bold"></i>Chat</a></li>
                        ...
                        <li class="shopping-cart" style="margin-left: 20px"><a href="{{ route('pesanan_user') }}"
                                class="cart"><span><small>{{ $total }}</small><i
